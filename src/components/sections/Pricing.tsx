  ...
  const plans = [
    {
      ...
      price: 'Free',
      period: 'forever',
      description: 'Essential tools for Islamic finance beginners',
      icon: Star,
      features: [
        'Basic Zakat calculator',
        'Limited halal screening (5/month)',
    ...
    },
    {
      ...
      price: '$49',
      period: 'month',
      description: 'Advanced tools for active Muslim investors',
      icon: TrendingUp,
      features: [
        'Everything in Seeker',
        'Unlimited halal screening',
    ...
    },
    {
      ...
      features: [
        ...
        'Legacy Blueprint generator',
        'Family portfolio management',
        'Inheritance planning tools',
        'Monthly scholar consultations',
    ...
    },
    {
      ...
      price: '$299',
      period: 'month',
      description: 'Elite service for ultra-high-net-worth families',
      icon: Diamond,
      features: [
